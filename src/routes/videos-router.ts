...
videosRouter.post(`/`, titleValidation, minAgeRestriction, authorValidation, canBeDownloadedValidation, availableResolutionsValidation, publicationDateValidation, validationMiddleware, (req: Request, res: Response) => {
...
videosRouter.put(`/:id`, titleValidation, minAgeRestriction, authorValidation, canBeDownloadedValidation, availableResolutionsValidation, publicationDateValidation, validationMiddleware, (req: Request, res: Response) => {
